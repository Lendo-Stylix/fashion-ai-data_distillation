...
# %% [markdown]
# # CELL 3: Tải Model Qwen 3.5 và Cấu hình PEFT DoRA (Version 1: r=8, alpha=16)
# %%
...
trainer = SFTTrainer(
    ...
    args = SFTConfig(
        ...
        optim = "adamw_8bit",
        seed = 3407,
        output_dir = "qwen-fashion-r8-alpha16-checkpoints",
        ...
        save_total_limit = 2,
        push_to_hub = True,
        hub_model_id = "YOUR_USERNAME/qwen-3.5-fashion-r8-alpha16",
